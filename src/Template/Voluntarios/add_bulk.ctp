<!-- File: src/Template/Voluntarios/add_bulk.ctp -->

<?php $this->assign('title', 'Add Volunteers To');?>

<?php
    echo $this->Form->create($voluntarios,['type'=>'post','enctype' => 'multipart/form-data']);
