 ...
 * @method \App\Model\Entity\Translator|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 * @method \App\Model\Entity\Translator findOrCreate($search, callable $callback = null, $options = [])
 *
